[![CRC RevEng](https://reveng.sourceforge.io/logo.png "CRC RevEng")](https://reveng.sourceforge.io/)
...
-   For the algorithm often misidentified as CCITT, see [CRC-16/IBM-3740](https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-ibm-3740).
-   [ITU-T Recommendation V.41](https://www.itu.int/rec/T-REC-V.41/en) (November 1988)
    -   **I** Definition: Residue; full mathematical description (Section 2, p.2)
    -   **I** Shift register diagrams (Appendix I, p.9)
-   Frank da Cruz (June 1986), [Kermit Protocol Manual, Sixth Edition](https://web.archive.org/web/20230121021518/http://www.columbia.edu/kermit/ftp/e/kproto.doc) (plain text; courtesy of the Internet Archive)
...
-   PVL Team (25 October 2008), CRC .NET control, version 14.0.0.0
    -   **II** Implementation
-   Aviation Data Systems (Aust) Pty Ltd. (13 June 2006), [PC.ACARS-G](https://web.archive.org/web/20120320092016/http://www.avdat.com.au/airground/acars_software.html) ACARS client (PATS presentation) (courtesy of the Internet Archive)
...
-   Atmel Corporation (30 March 2015), [Application Note ATAN0086: Using Atmel ATA5577 in Animal Identification Application according to ISO11784/85](https://www.mcselec.com/pub/an/Atmel-9114-ATAN0086-Using-ATA5577-in-Animal-Identification-Application_Application-Note.pdf) (courtesy of MCS Electronics)
...
-   reveng -m CRC-16/KERMIT -i 0047 -X -c 4E010203040506070809 → `6DD2`
-   reveng -m CRC-16/KERMIT -i 0047 -a 1 -X -c 011101001000000001000000110000000010000010100000 → `1110110000110110`
-   reveng -m CRC-16/KERMIT -i 0047 -a 1 -X -c 01110100100000000100000011000000001000001010000011 → `1011000011011000`
-   Unique effective solution of codeword set
-   Created: 10 September 2005
-   Updated: 4 August 2023
...
-   Dennis Sheirer (24 January 2015), [SDRTrunk](https://github.com/DSheirer/sdrtrunk) module [`sdrtrunk/src/main/java/io/github/dsheirer/edac/CRCLJ.java`](https://github.com/DSheirer/sdrtrunk/blob/master/src/main/java/io/github/dsheirer/edac/CRCLJ.java)
    -   **III** Code: Java
...
-   M17 Project (13 July 2023), [M17 protocol specification](https://spec.m17project.org/pdf/M17_spec.pdf), version 1.0
...
-   Class: attested
-   Youbok Lee, PhD, Microchip Technology Inc. (16 July 2001), ["CRC Algorithm for MCRF45X Read/Write Device"](https://ww1.microchip.com/downloads/en/AppNotes/00752a.pdf)
    -   **I** Definition: Width, Poly (reverse form) (p.1)
    -   **I** Shift register diagram (p.1)
    -   **I** Flowchart (p.2)
    -   **I** Worked example (p.3)
    -   **I** Code: C (pp.4–5)
-   Piers Desrochers, PICList MassMind, ["A quick guide to CRC"](https://web.archive.org/web/20230321201828/http://www.piclist.com/techref/method/error/quickcrc16.htm) (courtesy of the Internet Archive)
    -   **III** Description
    -   **III** Worked example
-   William H. Press, Brian P. Flannery, Saul A. Teukolsky, William T. Vetterling (1992), Numerical recipes in C: The art of scientific computing, 2nd ed., Cambridge University Press, ISBN 0-521-43108-5
    -   **III** All parameters (except Check) (p.898)
...
-   "kilobravo" (16 June 2008), Computer Interfacing Forum [topic 578](https://web.archive.org/web/20181116143720/https://www.lammertbies.nl/forum/viewtopic.php?t=578) (courtesy of the Internet Archive)
    -   **IV** 2 codewords
        -   `3A7164D9`
        -   `3A916A3E`
-   Unique effective solution of codeword set
...
-   MODICON Inc. (June 1996), [Modbus Protocol Reference Guide](https://modbus.org/docs/PI_MBUS_300.pdf), Rev. J
...
-   Ondřej Karas (28 February 2006), CRC calculator
    -   **II** Implementation
-   Panu-Kristian Poiksalo (28 February 2003), Control.com [forum post](https://control.com/forums/threads/modbus-source-code-in-pascal-or-c.7576/)
...
-   iBiquity Digital Corporation (23 August 2011), [HD Radio™ Air Interface Design Description: Station Information Service Transport](https://www.nrscstandards.org/standards-and-guidelines/documents/standards/nrsc-5-d/reference-docs/1020s.pdf), rev. J (courtesy of National Radio Systems Committee)
...
-   Andrew Wesie (9 June 2017), [NRSC-5 receiver for rtl-sdr](https://github.com/theori-io/nrsc5), file [`nrsc5/support/sample.xz`](https://github.com/theori-io/nrsc5/raw/master/support/sample.xz) (XZ compressed raw radio recording, 22 MB)
    -   **II** Recording confirming implementation with 28 codewords (4 bits extrapolated; selection)
        -   `000048BBABA0329A0A0A2671` (source: `00001010000010101001101000110010101000001010101110111011010010000000000100100110`)
        ...
        -   `00100000DC69FABC4E0AB6CD` (source: `00001010010011101011110011111010011010011101110000000000000000000001110110110110`)
        -   `000015004000809E54456AC7` (source: `01000101010101001001111010000000000000000100000000000000000101010000011101101010`)
        -   `00200008FA7E849E54454B82` (source: `01000101010101001001111010000100011111101111101000001000000000000010001001001011`)
        -   `001000744280849E54457C5C` (source: `01000101010101001001111010000100100000000100001001110100000000000001110001111100`)
-   Andrew Wesie, Clayton Smith et al. (17 April 2018), [NRSC-5 receiver for rtl-sdr](https://github.com/theori-io/nrsc5), module [`nrsc5/src/pids.c`](https://github.com/theori-io/nrsc5/blob/master/src/pids.c)
    -   **III** Code: C
-   Created: 16 November 2018
-   Updated: 20 March 2019
...
-   Class: attested
-   The single codeword is supported by the codewords confirming [CRC-8/OPENSAFETY](https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-opensafety), defined identically apart from Width, Poly in the same standard.
-   Ethernet POWERLINK Standardisation Group (18 October 2018), [OpenSAFETY Safety Profile Specification Working Draft Proposal](https://www.ethernet-powerlink.org/fileadmin/user_upload/Dokumente/Downloads/TECHNICAL_DOCUMENTS/EPSG_WDP_304_V-1-5-2.pdf), version 1.5.2
    -   **I** Full description (Section 5.1.2.6, pp.43–4)
    -   **I** Error detection capability (Section 8.1, p.182)
    -   **I** Code: C (Appendix 1, pp.196–9)
...
-   Prof. Philip Koopman, Tridib Chakravarty (June 2004), [Cyclic Redundancy Code (CRC) Polynomial Selection for Embedded Networks](https://users.ece.cmu.edu/~koopman/roses/dsn04/koopman04_crc_poly_embedded.pdf)
    -   **III** Assessment of polynomial performance (as `0xAC9A` or C<sub>3</sub>)
-   Created: 22 July 2016
-   Updated: 7 May 2022
...
-   PROFIBUS International (March 1998), [PROFIBUS Specification, Normative Parts](https://web.archive.org/web/20081116195826/https://www.kuebler.com/PDFs/Feldbus_Multiturn/specification_DP.pdf), Edition 1.0, Part 9 (courtesy of the Internet Archive)
...
-   "Chetanya" (17 November 2011), Computer Interfacing Forum [topic 1752](https://web.archive.org/web/20181116160912/https://www.lammertbies.nl/forum/viewtopic.php?t=1752) (courtesy of the Internet Archive)
...
-   "Snamprogetti" (17 April 2009), Computer Interfacing Forum [topic 1305](https://web.archive.org/web/20181116155838/https://www.lammertbies.nl/forum/viewtopic.php?t=1305) (courtesy of the Internet Archive)
    -   **III** Definition: Width, Poly, Init
    -   **III** Algorithm reported to be [CRC-CCITT](https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-kermit), implying RefIn and RefOut.
    -   **IV** 1 codeword
        -   `2022525330308790`
...
-   Fujitsu Semiconductor (10 October 2007), [FlexRay ASSP MB88121B User's Manual](https://web.archive.org/web/20221017013602/https://www.fujitsu.com/downloads/MICRO/fma/pdfmcu/um-mb88121-am15-11201-1e.pdf) (courtesy of the Internet Archive)
...
-   Gerald Houlder, INCITS Technical Committee T10 (2 May 2003), [End-to-End Data Protection Proposal](https://www.t10.org/ftp/t10/document.03/03-111r0.pdf)
    -   **I** Definition: Poly, Init (p.6)
    -   **I** Shift register diagram (p.18)
-   George O. Penokie, INCITS Technical Committee T10 (22 October 2003), [Simplified End-to-End Data Protection](https://www.t10.org/ftp/t10/document.03/03-176r9.pdf)
...
-   Ralph Weber, John Lohmeyer, INCITS Technical Committee T10 (20 August 2003), [Minutes of Data Integrity Study Group - Aug 19-20, 2003](https://www.t10.org/ftp/t10/document.03/03-281r0.pdf)
    -   **I** Definition: Init, XorOut (Item 4.6, p.3)
    -   **I** Acceptance of previous two documents (Item 4.7, p.3)
-   Pat Thaler, INCITS Technical Committee T10 (28 August 2003), [16-bit CRC polynomial selection](https://www.t10.org/ftp/t10/document.03/03-290r0.pdf)
    -   **I** Properties of polynomial
-   Martin K. Petersen, Oracle Corporation (2007); Tim Chen, Intel Corporation (2013), Linux module [`crypto/crct10dif_common.c`](https://stuff.mit.edu/afs/sipb/contrib/linux/crypto/crct10dif_common.c)
    -   **III** Code: C
...
-   Class: confirmed
-   Used in the Teledisk disc archive format. DECnet and [CRCK](https://mdfs.net/Archive/info-cpm/1985/10/09/064929.htm) allegedly use a Sick-type algorithm but with this polynomial.
-   Will Kranz (8 December 2002), [wteledsk 1.01](https://github.com/jmechnich/wteledsk)
    -   **II** Implementation
-   Will Kranz (8 December 2002), [wteledsk 1.01](https://github.com/jmechnich/wteledsk) module [`src/tdcrc.c`](https://github.com/jmechnich/wteledsk/blob/master/src/tdcrc.c)
    -   **III** Code: C
-   Created: 10 December 2009
-   Updated: 4 August 2023
...
-   Class: attested
-   Texas Instruments, Inc. (November 2009), [TMS37157 datasheet](https://www.ti.com/lit/ds/symlink/tms37157.pdf)
    -   **I** Full definition (except Check) (pp.39–40)
    -   **I** Shift register diagram (Figure 51, p.39)
    -   **I** Flowchart (Figure 52, p.40)
-   "harper", "jacknad" (November 2010–January 2011), StackOverflow [submitted question and answers](https://stackoverflow.com/questions/4286447/how-to-calculate-the-crc-in-rfid-protocol)
    ...
    -   **IV** 3 codewords ("harper")
        ...
        -   `024000000000A060E7`
        -   `024100000000A46FA5`
-   "Petri" (4 May 2010), Texas Instruments, Inc. E2E™ Community [forum post](https://e2e.ti.com/support/wireless-connectivity/other-wireless/f/667/t/46777)
    -   **IV** 1 codeword
        -   `01AAAAAAAAAADC25AB`
-   Unique effective solution of codeword set
...
-   Verifone, Inc. (May 1995), [TCLOAD Reference Manual](https://web.archive.org/web/20120603221525/http://www.verifone.com/PDF/guides/tcl_ref.pdf) (courtesy of the Internet Archive)
...
-   Emil Lenchak, Texas Instruments, Inc. (June 2018), [CRC Implementation With MSP430](https://www.ti.com/lit/an/slaa221a/slaa221a.pdf)
    -   **III** All parameters (except Residue) (Section 4.6, p.6)
-   Thomas Schmidt, Microchip Technology Inc. (20 May 2000), ["CRC Generating and Checking"](https://ww1.microchip.com/downloads/en/AppNotes/00730a.pdf)
    -   **III** Description (p.4)
...
-   "Joshua" (31 May 2008), Computer Interfacing Forum [topic 530](https://web.archive.org/web/20181116142405/https://www.lammertbies.nl/forum/viewtopic.php?t=530) (courtesy of the Internet Archive)
    -   **IV** 2 codewords
        -   `0384901B56`
        -   `03848400001230314131333030323031333030311C39303062BF`
-   Michael Junker (26 October 2009), Computer Interfacing Forum [topic 1432](https://web.archive.org/web/20180920112011/https://www.lammertbies.nl/forum/viewtopic.php?t=1432) (courtesy of the Internet Archive)
    -   **IV** 7 codewords (7-bit payload characters)
        -   `01100110011101011000001100000110011001110101100001101000111010100` (source: `331D3030331D30` + `53716`)
        -   `01101000011101011000001100000110011001110101100001111000111001001` (source: `341D3030331D30` + `61897`)
        -   `01101010011101011000001100000110011001110101100000001000111001111` (source: `351D3030331D30` + `04559`)
        -   `01101100011101011000001100000110011001110101100001011000111000000` (source: `361D3030331D30` + `45504`)
        -   `01100110011101011010001100000110000001110101100000101000111000110` (source: `331D3430301D30` + `20934`)
        -   `01100110011101011000001100000111001001110101100001101000111110110` (source: `331D3030391D30` + `53750`)
        -   `01100010011101011000001100010110000001110101100000001001101010001` (source: `311D3031301D30` + `04945`)
-   Unique effective solution of codeword set
-   Created: 4 June 2008
-   Updated: 2 August 2023
...
-   The MSB-first form of the V.41 algorithm. For the LSB-first form see [CRC-16/KERMIT](https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-kermit). CRC presented high byte first.
...
-   Acorn Computers Ltd (October 1984), [BBC Microcomputer User Guide](https://web.archive.org/web/20230404231501/http://regregex.bbcmicro.net/BPlusUserGuide-1.07.pdf) (courtesy of the Internet Archive)
...
-   Class: academic
-   Robert Bosch GmbH (17 April 2012), [CAN with Flexible Data-Rate: Specification](https://web.archive.org/web/20151017122935/http://www.bosch-semiconductors.de/media/pdf_1/canliteratur/can_fd_spec.pdf), version 1.0 (courtesy of the Internet Archive)
...
-   BLE sniffer screenshot reference from "volta77" (29 May 2014), [Nordic Developer Zone post](https://devzone.nordicsemi.com/question/2104/ble-crc-calculation/)
-   Bluetooth SIG (31 January 2023), [Bluetooth Specification](https://www.bluetooth.com/specifications/), [Core Version 5.4](https://www.bluetooth.org/DocMan/handlers/DownloadDoc.ashx?doc_id=521059)
...
-   Liam Goudge (1 October 2014), ["Custom Bluetooth Low Energy board with 2.4GHz antenna hack and Nordic nRF51822…"](https://www.cocoasteam.com/?p=384)
...
-   Anonymous (7 September 2012), [BLE sniffer screenshot](https://e2e.ti.com/cfs-file/__key/communityserver-discussions-components-files/538/4353.btproblem2.png) (courtesy of Texas Instruments, Inc. E2E™ Community forum)
...
-   Class: attested
-   Alias: **CRC-24**
-   [IETF RFC 4880](https://datatracker.ietf.org/doc/html/rfc4880) (November 2007)
...
-   Class: attested
-   Microware Systems Corporation (January 1983), [OS-9 Operating System, System Programmer's Manual](https://www.roug.org/soren/6809/os9sysprog.pdf), revision F-1 (PDF, [HTML](https://www.roug.org/soren/6809/os9sysprog.html)) (courtesy of Søren Roug)
    -   **I** Definition: Width, Poly, Init, XorOut, Residue (Section 10.1.4, pp.51–2)
    -   **I** Code: C (Section 10.1.4, p.52)
-   Microware Systems Corporation (August 2000), [OS-9 Technical Manual, version 2.2](https://web.archive.org/web/20140829020824/http://rab.ict.pwr.wroc.pl/dydaktyka/supwa/os9/MWARE/pdf/os9k_tech.pdf), revision I (courtesy of the Internet Archive)
    -   **I** Definition: Init, Residue (Chapter 8, p.228)
-   Microware Inc., TPUG Inc. (1985), [SuperOS-9 system disk](https://web.archive.org/web/20230121021519/http://mikenaberezny.com/wp-content/uploads/2009/11/os9-systemdisk.d80) (courtesy of the Internet Archive)
...
-   Søren Roug (15 May 2018), [osnine-java](https://github.com/sorenroug/osnine-java), module [`os9l1/src/main/java/org/roug/osnine/os9/OS9.java`](https://github.com/sorenroug/osnine-java/blob/master/os9l1/src/main/java/org/roug/osnine/os9/OS9.java)
...
-   Class: academic
-   Reference from named polynomial in Prof. Koopman's [CRC Polynomial Zoo](https://users.ece.cmu.edu/~koopman/crc/notes.html).
-   CCSA Telecommunication Industry Standard [YD/T 1838.3-2008](https://web.archive.org/web/20181118221951/https://www.ccsa.org.cn/english/yd1838/Technical%20Requirements%20of%20Link%20Access%20Control%20(LAC)%20for%20the%20CDMA-based%20Digital%20Trunking%20Mobile%20Communication%20System.pdf) (5 November 2008; courtesy of the Internet Archive)
...
-   AVMagazine.it has a [forum topic](https://www.avmagazine.it/forum/107-disc-ufficiali-lcd-full-hd/50543-philips-37pf9731/) on the Philips TV (in Italian).
-   Philips 37PF9731 LCD TV
    -   **II** Implementation
-   "gigirex" (1 March 2012), Computer Interfacing Forum [topic 1774](https://web.archive.org/web/20181116141051/https://www.lammertbies.nl/forum/viewtopic.php?t=1774) (courtesy of the Internet Archive)
...
-   EUROCONTROL (20 March 2006), [AIXM Primer 4.5](https://www.aixm.aero/sites/aixm.aero/files/imce/library/aixm_primer_4-5.pdf)
...
-   Greg Cook (30 December 2018), Base91 level 1 version 3.01
    ...
    -   **III** All parameters
    -   **III** Code: C
-   Prof. Philip Koopman (July 2002), ["32-Bit Cyclic Redundancy Codes for Internet Applications"](https://users.ece.cmu.edu/~koopman/networks/dsn02/dsn02_koopman.pdf), Proceedings of The International Conference on Dependable Systems and Networks
...
-   [ITU-T Recommendation I.363.5](https://www.itu.int/rec/T-REC-I.363.5/en) (August 1996)
...
-   Emil Lenchak, Texas Instruments, Inc. (June 2018), [CRC Implementation With MSP430](https://www.ti.com/lit/an/slaa221a/slaa221a.pdf)
    -   **III** All parameters (except Residue) (Section 4.6, p.6)
-   Richard Black (18 February 1994), [Fast CRC32 in Software: Software Implementations](https://www.cl.cam.ac.uk/research/srg/bluebook/21/crc/node6.html)
    -   **III** Code: C
-   Richard Black (18 February 1994), [Fast CRC32 in Software: Some Examples](https://www.cl.cam.ac.uk/research/srg/bluebook/21/crc/node4.html)
    -   **IV** 3 codewords (same as in I.363.5)
-   Angie Tso, Telecommunications Techniques Corp. (24 October 1994), [Cell Relay mailing list post](https://web.archive.org/web/20061009235306/http://cell-relay.indiana.edu/cell-relay/publications/software/CRC/32bitCRC.testcases.html) (courtesy of the Internet Archive)
...
-   Ryan Luecke, James Lyons (11 October 2011), [CRC32 Checksums; The Good, The Bad, And The Ugly](https://web.archive.org/web/20170117015325/https://blog.box.com/blog/crc32-checksums-the-good-the-bad-and-the-ugly/) (courtesy of the Internet Archive)
    -   **IV** 1 codeword
        -   `6173640A86FA4F5B`
-   Unique effective solution of codeword set
...
-   Heiko Eißfeldt, Jörg Schilling (28 April 2013), [cdrtools](https://www.berlios.de/software/cdrtools/) 3.01 (in German), [source code distribution](https://sourceforge.net/projects/cdrtools/files/cdrtools-3.01.tar.bz2/download) (Bzip2 compressed tarfile), modules `cdrtools-3.01/libedc/crctable.out`, `cdrtools-3.01/libedc/edc_ecc.c`
...
-   The Open Group (1997), Single Unix Specification, version 2, Commands & Utilities Issue 5, Reference Pages: [cksum](https://pubs.opengroup.org/onlinepubs/7990989775/xcu/cksum.html)
...
-   [IETF RFC 7143](https://datatracker.ietf.org/doc/html/rfc7143) (April 2014)
...
-   Greg Cook (30 December 2018), Base91 level 1 version 3.01
    ...
    -   **III** All parameters
    -   **III** Code: C
-   Mark Bakke, Julian Satran, Venkat Rangan (May–June 2001), [IP Storage Mailing List thread](https://www.pdl.cmu.edu/mailinglists/ips/mail/msg04970.html)
...
-   AUTOSAR (24 November 2022), [AUTOSAR Classic Platform](https://www.autosar.org/standards/classic-platform/) release R22-11, [Specification of CRC Routines](https://www.autosar.org/fileadmin/user_upload/standards/classic/22-11/AUTOSAR_SWS_CRCLibrary.pdf)
    ...
    -   **IV** 7 codewords (Section 7.2.3.1, p.28)
        ...
        -   `926B559BA2DE9C`
        -   `FFFFFFFFFFFFFFFF`
-   Lasse Collin, Igor Pavlov et al. (27 August 2009), [The .xz file format](https://tukaani.org/xz/xz-file-format.txt), version 1.0.4
    -   **I** Code: C (Section 6)
-   [IETF RFC 1662](https://datatracker.ietf.org/doc/html/rfc1662) (July 1994)
...
-   Berndt M. Gammel (29 October 2006), [Matpack 1.9.1](https://www.matpack.de/) class `MpCRC` documentation
    -   **III** All parameters (except Residue)
-   Cisco Systems (September 2013), [Meraki Air Marshal white paper](https://meraki.cisco.com/lib/pdf/meraki_whitepaper_air_marshal.pdf)
    -   **IV** 1 codeword (p.9)
        -   `C008300028CFE9521D3B08EA449900E808EA449900E8300102007E649416`
-   Ryan Luecke, James Lyons (11 October 2011), [CRC32 Checksums; The Good, The Bad, And The Ugly](https://blog.box.com/blog/crc32-checksums-the-good-the-bad-and-the-ugly/)
    -   **IV** 1 codeword
        -   `6173640ACEDE2D15`
-   Unique effective solution of codeword set
-   Created: 30 March 2005
...
-   Mayo Foundation (19 February 2016), [Multiscale Electrophysiology File Format Version 3.0 (MEF3) specification](https://github.com/msel-source/meflib/raw/multiplatform/MEF%203%20Specification.pdf) (courtesy of GitHub)
    -   **I** Definition: Init (p.90), Width (p.91)
    -   **I** Citation for Poly: "Koopman" (p.91)
-   Dan Crepeau (27 Sep 2021), [Sample MEF 3.0 data](https://github.com/msel-source/sampledata/raw/master/sample_data.mefd.tar) (tar archive)
...
-   Matt Stead, Ben Brinkmann, Dan Crepeau, Mayo Foundation (2013), [Multiscale Electrophysiology Format (MEF) version 3.0 library](https://github.com/msel-source/meflib), modules [`meflib/meflib.c`](https://github.com/msel-source/meflib/blob/multiplatform/meflib/meflib.c), [`meflib/meflib.h`](https://github.com/msel-source/meflib/blob/multiplatform/meflib/meflib.h)
    -   **III** Code: C
...
-   Dipl. Inf. Johann F. Löfflmann (30 July 2006), Jacksum 1.7.0
    -   **II** Implementation
-   VideoLAN Organization (13 October 2022), [VLC 3.0.18](https://www.videolan.org/vlc/) module [`vlc-3.0.11/modules/mux/mpeg/ps.c`](https://code.videolan.org/videolan/vlc/-/blob/master/modules/mux/mpeg/ps.c)
    -   **III** Code: C
-   Created: 8 October 2008
-   Updated: 4 August 2023
...
-   Class: confirmed
-   Alias: **XFER**
-   Jon Welch (12 January 2007), [XFER in C, version 5.1a](https://www.g7jjf.com/bbc.htm)
    -   **II** Implementation
-   William H. Press, Brian P. Flannery, Saul A. Teukolsky, William T. Vetterling (1992), Numerical recipes in C: The art of scientific computing, 2nd ed., Cambridge University Press, ISBN 0-521-43108-5
...
-   Patrick Geremia, Texas Instruments, Inc. (April 1999), [Cyclic Redundancy Check Computation: An Implementation Using the TMS320C54x](https://www.ti.com/lit/an/spra530/spra530.pdf)
    -   **III** Definition: Width, Poly (p.5)
...
-   Class: academic
-   Alias: **CRC-64**
-   Used in DLT-1 tape cartridges. For the algorithm often misidentified as ECMA, see [CRC-64/XZ](https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-64-xz).
-   [ECMA standard ECMA-182](https://www.ecma-international.org/wp-content/uploads/ECMA-182_1st_edition_december_1992.pdf) (December 1992) — ISO/IEC 13421:1993
...
-   The Go Authors, [The Go Programming Language](https://go.dev/), package [`crc64`](https://pkg.go.dev/hash/crc64)
    -   **II** Implementation (using constant `crc64.ISO`)
-   The Go Authors (26 January 2017), The Go Programming Language, module [`src/hash/crc64/crc64.go`](https://go.dev/src/hash/crc64/crc64.go)
    -   **III** Code: Go
-   The Go Authors (26 January 2017), The Go Programming Language, module [`src/hash/crc64/crc64_test.go`](https://go.dev/src/hash/crc64/crc64_test.go)
...
-   Microsoft Corporation (25 June 2021), [\[MS-FCIADS\]: File Classification Infrastructure Alternate Data Stream (ADS) File Format](https://winprotocoldoc.blob.core.windows.net/productionwindowsarchives/MS-FCIADS/%5bMS-FCIADS%5d.pdf)
...
-   Hexacorn Ltd (30 April 2013), [JumpLists file names and AppID calculator](https://www.hexacorn.com/blog/2013/04/30/jumplists-file-names-and-appid-calculator/)
...
-   Class: academic
-   Contributed by [Johann N. Löfflmann](https://sourceforge.net/p/reveng/discussion/general/thread/6d6bd1102b/#b6b6).
-   Matt Stancliff et al. (16 November 2021), [Redis](https://github.com/redis/redis) module [`redis/src/crc64.c`](https://github.com/redis/redis/blob/unstable/src/crc64.c)
...
-   An algorithm commonly misidentified as ECMA. For the true ECMA algorithm see [CRC-64/ECMA-182](https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-64-ecma-182).
-   Go implementation reference contributed by "freetrader".
-   AUTOSAR (24 November 2022), [AUTOSAR Classic Platform](https://www.autosar.org/standards/classic-platform/) release R22-11, [Specification of CRC Routines](https://www.autosar.org/fileadmin/user_upload/standards/classic/22-11/AUTOSAR_SWS_CRCLibrary.pdf)
    -   **I** Comprehensive primer on CRC theory (Section 7.1, pp.19–22)
...
-   Lasse Collin, Igor Pavlov et al. (21 May 2011), XZ Utils 5.0.3
    -   **II** Implementation
-   The Go Authors, [The Go Programming Language](https://golang.org/), package [`crc64`](https://golang.org/pkg/hash/crc64/)
    -   **II** Implementation (using constant `crc64.ECMA`)
-   The Go Authors (26 January 2017), The Go Programming Language, module [`src/hash/crc64/crc64.go`](https://golang.org/src/hash/crc64/crc64.go)
    -   **III** Code: Go
-   The Go Authors (26 January 2017), The Go Programming Language, module [`src/hash/crc64/crc64_test.go`](https://golang.org/src/hash/crc64/crc64_test.go)
    -   **IV** 32 codewords (selection)
        -   `0000000000000000`
        -   `61052B652E77840233`
...
-   ETSI [EN 300 751](https://www.etsi.org/deliver/etsi_en/300700_300799/300751/01.02.01_60/en_300751v010201p.pdf) version 1.2.1 (January 2003)
    ...
    -   See section 12 for details of the transmission order.
-   reveng -m CRC-82/DARC -X -c 02000102372050524F4A454354204D41494E4D454E553B48424065001049B5FB9ADE → `0000000000000000000000`
-   reveng -m CRC-82/DARC -a 1 -A 8 -r -X -c 0100000000000000100000000100000011101100000001000000101001001010111100100101001010100010110000100010101000000100101100101000001010010010011100101011001010100010011100101010101011011100000100 → `40424065001049B5FB9ADE`
-   Created: 14 December 2009
-   Updated: 23 December 2021

## Summary

<table><caption>Summary of the CRC catalogue</caption><tbody><tr><th rowspan="2">CRC width (bits)</th><th colspan="5">Records</th></tr><tr><th><span>Attested</span></th><th><span>Confirmed</span></th><th><span>Academic</span></th><th><span>Third-party</span></th><th>Total</th></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.3">3</a></td><td>–</td><td>–</td><td>2</td><td>–</td><td>2</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.4">4</a></td><td>–</td><td>–</td><td>2</td><td>–</td><td>2</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.5">5</a></td><td>1</td><td>–</td><td>1</td><td>1</td><td>3</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.6">6</a></td><td>2</td><td>–</td><td>3</td><td>–</td><td>5</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.7">7</a></td><td>–</td><td>–</td><td>3</td><td>–</td><td>3</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.8">8</a></td><td>12</td><td>–</td><td>7</td><td>1</td><td>20</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.10">10</a></td><td>1</td><td>–</td><td>2</td><td>–</td><td>3</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.11">11</a></td><td>1</td><td>–</td><td>1</td><td>–</td><td>2</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.12">12</a></td><td>–</td><td>–</td><td>4</td><td>–</td><td>4</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.13">13</a></td><td>1</td><td>–</td><td>–</td><td>–</td><td>1</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.14">14</a></td><td>1</td><td>–</td><td>1</td><td>–</td><td>2</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.15">15</a></td><td>1</td><td>–</td><td>1</td><td>–</td><td>2</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.16">16</a></td><td>23</td><td>3</td><td>1</td><td>4</td><td>31</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.17">17</a></td><td>–</td><td>–</td><td>1</td><td>–</td><td>1</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.21">21</a></td><td>–</td><td>–</td><td>1</td><td>–</td><td>1</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.24">24</a></td><td>5</td><td>–</td><td>3</td><td>–</td><td>8</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.30">30</a></td><td>–</td><td>–</td><td>1</td><td>–</td><td>1</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.31">31</a></td><td>–</td><td>1</td><td>–</td><td>–</td><td>1</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.32">32</a></td><td>8</td><td>3</td><td>1</td><td>–</td><td>12</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.40">40</a></td><td>–</td><td>–</td><td>1</td><td>–</td><td>1</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.64">64</a></td><td>2</td><td>2</td><td>2</td><td>–</td><td>6</td></tr><tr><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat-bits.82">82</a></td><td>1</td><td>–</td><td>–</td><td>–</td><td>1</td></tr><tr><th>Total</th><td>59</td><td>9</td><td>38</td><td>6</td><td>112</td></tr></tbody></table>
...
-   [https://web.archive.org/web/20190527220400/http://www.ross.net/crc/download/crc\_v3.txt](https://web.archive.org/web/20190527220400/http://www.ross.net/crc/download/crc_v3.txt)
-   [https://web.archive.org/web/20190523182111/http://www.wolfgang-ehrhardt.de/crc\_v3.html](https://web.archive.org/web/20190523182111/http://www.wolfgang-ehrhardt.de/crc_v3.html)
...
-   [https://web.archive.org/web/20170702024257/https://www.lammertbies.nl/forum/viewforum.php?f=11](https://web.archive.org/web/20170702024257/https://www.lammertbies.nl/forum/viewforum.php?f=11)

Jonathan Graham Harston (21–23 June 2011), "Source Code for Calculating CRCs".

-   [https://mdfs.net/Info/Comp/Comms/CRCs.htm](https://mdfs.net/Info/Comp/Comms/CRCs.htm)
-   [https://mdfs.net/Info/Comp/Comms/CRC16.htm](https://mdfs.net/Info/Comp/Comms/CRC16.htm)
-   [https://mdfs.net/Info/Comp/Comms/CRC32.htm](https://mdfs.net/Info/Comp/Comms/CRC32.htm)

PicList MassMind, "Cyclic Redundancy Check error detection".

-   [https://web.archive.org/web/20230121021528/http://www.piclist.com/techref/method/error/crc.htm](https://web.archive.org/web/20230121021528/http://www.piclist.com/techref/method/error/crc.htm)

Tom Torfs, IOCCC winning entry, 1998, CRC generator.

-   [https://www.ioccc.org/years.html#1998\_tomtorfs](https://www.ioccc.org/years.html#1998_tomtorfs)
...
<table><caption>Karnaugh map of the most common 16-bit CRCs, with <var>Check</var> values and algorithm citations. All values are hexadecimal.</caption><tbody><tr><th rowspan="2">"123456789"<br>(UTF-8)</th><th>Polynomial</th><th colspan="2">1021</th><th colspan="2">8005</th></tr><tr><th>Reflected?</th><th>False</th><th colspan="2">True</th><th>False</th></tr><tr><th>Initial value</th><th>Final XOR</th><th colspan="4"></th></tr><tr><th rowspan="2">0000</th><th>0000</th><td>31C3<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-xmodem">XMODEM</a></cite>)</td><td>2189<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-kermit">KERMIT</a></cite>)</td><td>BB3D<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-arc">ARC</a></cite>)</td><td>FEE8<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-umts">UMTS</a></cite>)</td></tr><tr><th rowspan="2">FFFF</th><td>CE3C<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-gsm">GSM</a></cite>)</td><td>DE76<br>(–)</td><td>44C2<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-maxim-dow">MAXIM</a></cite>)</td><td>0117<br>(–)</td></tr><tr><th rowspan="2">FFFF</th><td>D64E<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-genibus">GENIBUS</a></cite>)</td><td>906E<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-ibm-sdlc">SDLC</a></cite>)</td><td>B4C8<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-usb">USB</a></cite>)</td><td>5118<br>(–)</td></tr><tr><th>0000</th><td>29B1<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-ibm-3740">IBM 3740</a></cite>)</td><td>6F91<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-mcrf4xx">MCRF4XX</a></cite>)</td><td>4B37<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-modbus">MODBUS</a></cite>)</td><td>AEE7<br>(<cite><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-cms">CMS</a></cite>)</td></tr></tbody></table>

## Appendix B

Cross-reference of generator polynomials to Professor Koopman's CRC Polynomial Zoo.

<table><caption>Generator polynomials appearing in the CRC Catalogue</caption><tbody><tr><th rowspan="2">Width</th><th colspan="3">Polynomial</th><th rowspan="2"><cite>Zoo</cite> names</th><th rowspan="2">Models</th></tr><tr><th>Direct</th><th>Reflected</th><th>Koopman</th></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc3.html">3</a></td><td><code>0x3</code></td><td><code>0x6</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c03/0x5_len.txt"><code>0x5</code></a></td><td>(*p) CRC-3K; RFC 3095; FP-3</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-3-gsm"><code>CRC-3/GSM</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-3-rohc"><code>CRC-3/ROHC</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc4.html">4</a></td><td><code>0x3</code></td><td><code>0xc</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c04/0x9_len.txt"><code>0x9</code></a></td><td>(*p) CCITT-4; FP-4; ITU-T G.704</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-4-g-704"><code>CRC-4/G-704</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-4-interlaken"><code>CRC-4/INTERLAKEN</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc5.html">5</a></td><td><code>0x05</code></td><td><code>0x14</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c05/0x12_len.txt"><code>0x12</code></a></td><td>(*p) CRC-5-EPC; CRC-5-USB; FP-5</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-5-usb"><code>CRC-5/USB</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc5.html">5</a></td><td><code>0x09</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c05/0x12_len.txt"><code>0x12</code></a></td><td>*&lt; <code>0x14</code></td><td>(*p) CRC-5-EPC; CRC-5-USB; FP-5</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-5-epc-c1g2"><code>CRC-5/EPC-C1G2</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc5.html">5</a></td><td><code>0x15</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c05/0x15_len.txt"><code>0x15</code></a></td><td>*&lt; <code>0x1a</code></td><td>(*op) CRC-5; CRC-5-ITU; CRC-5F/4; FOP-5 ("65")</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-5-g-704"><code>CRC-5/G-704</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc6.html">6</a></td><td><code>0x03</code></td><td><code>0x30</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c06/0x21_len.txt"><code>0x21</code></a></td><td>(*p) CRC-6; CRC-6-ITU; FP-6</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-6-g-704"><code>CRC-6/G-704</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc6.html">6</a></td><td><code>0x07</code></td><td><code>0x38</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c06/0x23_len.txt"><code>0x23</code></a></td><td>(*op) CRC-6-CDMA2000-B; FOP-6</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-6-cdma2000-b"><code>CRC-6/CDMA2000-B</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc6.html">6</a></td><td><code>0x19</code></td><td><code>0x26</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c06/0x2c_len.txt"><code>0x2c</code></a></td><td>(*op) DARC-6</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-6-darc"><code>CRC-6/DARC</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc6.html">6</a></td><td><code>0x27</code></td><td><code>0x39</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c06/0x33_len.txt"><code>0x33</code></a></td><td>(*p) CRC-6-CDMA2000-A; CRC-6F/3 ("147p")</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-6-cdma2000-a"><code>CRC-6/CDMA2000-A</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc6.html">6</a></td><td><code>0x2f</code></td><td><code>0x3d</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c06/0x37_len.txt"><code>0x37</code></a></td><td>(*op) CRC-6-GSM; CRC-6F/4 ("157")</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-6-gsm"><code>CRC-6/GSM</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc7.html">7</a></td><td><code>0x09</code></td><td><code>0x48</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c07/0x44_len.txt"><code>0x44</code></a></td><td>(*p) CRC-7</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-7-mmc"><code>CRC-7/MMC</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc7.html">7</a></td><td><code>0x45</code></td><td><code>0x51</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c07/0x62_len.txt"><code>0x62</code></a></td><td>(*op) CRC-7P</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-7-umts"><code>CRC-7/UMTS</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc7.html">7</a></td><td><code>0x4f</code></td><td><code>0x79</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c07/0x67_len.txt"><code>0x67</code></a></td><td>(*o) RFC 3095</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-7-rohc"><code>CRC-7/ROHC</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0x07</code></td><td><code>0xe0</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c08/0x83_len.txt"><code>0x83</code></a></td><td>(*op) FOP-8; ATM-8; CRC-8P</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-i-432-1"><code>CRC-8/I-432-1</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-rohc"><code>CRC-8/ROHC</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-smbus"><code>CRC-8/SMBUS</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0x31</code></td><td><code>0x8c</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c08/0x98_len.txt"><code>0x98</code></a></td><td>(*op) DOWCRC</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-maxim-dow"><code>CRC-8/MAXIM-DOW</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-nrsc-5"><code>CRC-8/NRSC-5</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0x1d</code></td><td><code>0xb8</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c08/0x8e_len.txt"><code>0x8e</code></a></td><td>(*p) SAE J-1850; FP-8</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-gsm-a"><code>CRC-8/GSM-A</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-hitag"><code>CRC-8/HITAG</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-i-code"><code>CRC-8/I-CODE</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-mifare-mad"><code>CRC-8/MIFARE-MAD</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-sae-j1850"><code>CRC-8/SAE-J1850</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-tech-3250"><code>CRC-8/TECH-3250</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0x49</code></td><td><code>0x92</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c08/0xa4_len.txt"><code>0xa4</code></a></td><td>(*o) CRC-8-GSM-B</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-gsm-b"><code>CRC-8/GSM-B</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0x2f</code></td><td><code>0xf4</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c08/0x97_len.txt"><code>0x97</code></a></td><td>(*op) C2; CRC-8-AUTOSAR; CRC-8F/4.2 ("457")</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-autosar"><code>CRC-8/AUTOSAR</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-opensafety"><code>CRC-8/OPENSAFETY</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0x39</code></td><td><code>0x9c</code></td><td>= <a href="https://users.ece.cmu.edu/~koopman/crc/c08/0x9c_len.txt"><code>0x9c</code></a></td><td>DARC-8</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-darc"><code>CRC-8/DARC</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0xd5</code></td><td><code>0xab</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c08/0xea_len.txt"><code>0xea</code></a></td><td>(*o) CRC-8</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-dvb-s2"><code>CRC-8/DVB-S2</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0x9b</code></td><td><code>0xd9</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c08/0xcd_len.txt"><code>0xcd</code></a></td><td>(*op) WCDMA-8</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-cdma2000"><code>CRC-8/CDMA2000</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-lte"><code>CRC-8/LTE</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-wcdma"><code>CRC-8/WCDMA</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc8.html">8</a></td><td><code>0xa7</code></td><td><code>0xe5</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c08/0xd3_len.txt"><code>0xd3</code></a></td><td>(*op) CRC-8-Bluetooth</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-8-bluetooth"><code>CRC-8/BLUETOOTH</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc10.html">10</a></td><td><code>0x3d9</code></td><td><code>0x26f</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c10/0x3ec_len.txt"><code>0x3ec</code></a></td><td>(*op) CRC-10-CMDA2000</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-10-cdma2000"><code>CRC-10/CDMA2000</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc10.html">10</a></td><td><code>0x175</code></td><td><code>0x2ba</code></td><td>= <a href="https://users.ece.cmu.edu/~koopman/crc/c10/0x2ba_len.txt"><code>0x2ba</code></a></td><td>CRC-10-GSM</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-10-gsm"><code>CRC-10/GSM</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc10.html">10</a></td><td><code>0x233</code></td><td><code>0x331</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c10/0x319_len.txt"><code>0x319</code></a></td><td>(*op) CRC-10</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-10-atm"><code>CRC-10/ATM</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc11.html">11</a></td><td><code>0x385</code></td><td><code>0x50e</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c11/0x5c2_len.txt"><code>0x5c2</code></a></td><td>(*o) FlexRay-11</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-11-flexray"><code>CRC-11/FLEXRAY</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc11.html">11</a></td><td><code>0x307</code></td><td><code>0x706</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c11/0x583_len.txt"><code>0x583</code></a></td><td>(*op) CRC-11F/4.2 "7015"</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-11-umts"><code>CRC-11/UMTS</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc12.html">12</a></td><td><code>0xd31</code></td><td><code>0x8cb</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c12/0xe98_len.txt"><code>0xe98</code></a></td><td>CRC-12-GSM</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-12-gsm"><code>CRC-12/GSM</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc12.html">12</a></td><td><code>0x80f</code></td><td><code>0xf01</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c12/0xc07_len.txt"><code>0xc07</code></a></td><td>(*op) CRC-12</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-12-dect"><code>CRC-12/DECT</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-12-umts"><code>CRC-12/UMTS</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc12.html">12</a></td><td><code>0xf13</code></td><td><code>0xc8f</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c12/0xf89_len.txt"><code>0xf89</code></a></td><td>(*op) CRC-12-CMDA2000</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-12-cdma2000"><code>CRC-12/CDMA2000</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc13.html">13</a></td><td><code>0x1cf5</code></td><td><code>0x15e7</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c13/0x1e7a_len.txt"><code>0x1e7a</code></a></td><td>(*o) CRC-13-BBC</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-13-bbc"><code>CRC-13/BBC</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc14.html">14</a></td><td><code>0x0805</code></td><td><code>0x2804</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c14/0x2402_len.txt"><code>0x2402</code></a></td><td>(*op) DARC-14 (*op)</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-14-darc"><code>CRC-14/DARC</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc14.html">14</a></td><td><code>0x202d</code></td><td><code>0x2d01</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c14/0x3016_len.txt"><code>0x3016</code></a></td><td>(*op) CRC-14-GSM</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-14-gsm"><code>CRC-14/GSM</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc15.html">15</a></td><td><code>0x4599</code></td><td><code>0x4cd1</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c15/0x62cc_len.txt"><code>0x62cc</code></a></td><td>(*o) CAN</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-15-can"><code>CRC-15/CAN</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc15.html">15</a></td><td><code>0x6815</code></td><td><code>0x540b</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c15/0x740a_len.txt"><code>0x740a</code></a></td><td>CRC-15-MPT1327</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-15-mpt1327"><code>CRC-15/MPT1327</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x0589</code></td><td><code>0x91a0</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0x82c4_len.txt"><code>0x82c4</code></a></td><td>(*o) CRC-16-DECT</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-dect-r"><code>CRC-16/DECT-R</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-dect-x"><code>CRC-16/DECT-X</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x080b</code></td><td><code>0xd010</code></td><td><code>0x8405</code></td><td>–</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-nrsc-5"><code>CRC-16/NRSC-5</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x1021</code></td><td><code>0x8408</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c16/0x8810_len.txt"><code>0x8810</code></a></td><td>(*op) CCITT-16</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-genibus"><code>CRC-16/GENIBUS</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-gsm"><code>CRC-16/GSM</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-ibm-3740"><code>CRC-16/IBM-3740</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-ibm-sdlc"><code>CRC-16/IBM-SDLC</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-iso-iec-14443-3-a"><code>CRC-16/ISO-IEC-14443-3-A</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-kermit"><code>CRC-16/KERMIT</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-mcrf4xx"><code>CRC-16/MCRF4XX</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-riello"><code>CRC-16/RIELLO</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-spi-fujitsu"><code>CRC-16/SPI-FUJITSU</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-tms37157"><code>CRC-16/TMS37157</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-xmodem"><code>CRC-16/XMODEM</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x1dcf</code></td><td><code>0xf3b8</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0x8ee7_len.txt"><code>0x8ee7</code></a></td><td>ProfiBus</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-profibus"><code>CRC-16/PROFIBUS</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x3d65</code></td><td><code>0xa6bc</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0x9eb2_len.txt"><code>0x9eb2</code></a></td><td>(*o) C1; CRC-16-DNP; CRC-16F/6.2 ("236545")</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-dnp"><code>CRC-16/DNP</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-en-13757"><code>CRC-16/EN-13757</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x8005</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0xa001_len.txt"><code>0xa001</code></a></td><td>*&lt; <code>0xc002</code></td><td>(*op) CRC-16; CRC-16-IBM</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-arc"><code>CRC-16/ARC</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-cms"><code>CRC-16/CMS</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-dds-110"><code>CRC-16/DDS-110</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-maxim-dow"><code>CRC-16/MAXIM-DOW</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-modbus"><code>CRC-16/MODBUS</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-umts"><code>CRC-16/UMTS</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-usb"><code>CRC-16/USB</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x5935</code></td><td><code>0xac9a</code></td><td>= <a href="https://users.ece.cmu.edu/~koopman/crc/c16/0xac9a_len.txt"><code>0xac9a</code></a></td><td>C3; CRC-16F/5 ("254465s")</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-m17"><code>CRC-16/M17</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-opensafety-a"><code>CRC-16/OPENSAFETY-A</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x6f63</code></td><td><code>0xc6f6</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0xb7b1_len.txt"><code>0xb7b1</code></a></td><td>IEEE WG77.1</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-lj1200"><code>CRC-16/LJ1200</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x755b</code></td><td><code>0xdaae</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0xbaad_len.txt"><code>0xbaad</code></a></td><td>CRC-16K/4</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-opensafety-b"><code>CRC-16/OPENSAFETY-B</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0x8bb7</code></td><td><code>0xedd1</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0xc5db_len.txt"><code>0xc5db</code></a></td><td>(*p) CRC-16-T10-DIF</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-t10-dif"><code>CRC-16/T10-DIF</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0xa097</code></td><td><code>0xe905</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0xd04b_len.txt"><code>0xd04b</code></a></td><td>(*o) IBM-16</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-teledisk"><code>CRC-16/TELEDISK</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc16.html">16</a></td><td><code>0xc867</code></td><td><code>0xe613</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c16/0xe433_len.txt"><code>0xe433</code></a></td><td>(*p) CRC-16-CMDA2000</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-16-cdma2000"><code>CRC-16/CDMA2000</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc17.html">17</a></td><td><code>0x1685b</code></td><td><code>0x1b42d</code></td><td>= <a href="https://users.ece.cmu.edu/~koopman/crc/c17/0x1b42d_len.txt"><code>0x1b42d</code></a></td><td>(*o) CRC-17-CAN</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-17-can-fd"><code>CRC-17/CAN-FD</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc21.html">21</a></td><td><code>0x102899</code></td><td><code>0x132281</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c21/0x18144c_len.txt"><code>0x18144c</code></a></td><td>(*o) CRC-21-CAN</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-21-can-fd"><code>CRC-21/CAN-FD</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc24.html">24</a></td><td><code>0x00065b</code></td><td><code>0xda6000</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c24/0x80032d_len.txt"><code>0x80032d</code></a></td><td>(*op) BLE-24 (Bluetooth Low Energy)</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-24-ble"><code>CRC-24/BLE</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc24.html">24</a></td><td><code>0x328b63</code></td><td><code>0xc6d14c</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c24/0x9945b1_len.txt"><code>0x9945b1</code></a></td><td>(*op) CRC-24/4</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-24-interlaken"><code>CRC-24/INTERLAKEN</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc24.html">24</a></td><td><code>0x5d6dcb</code></td><td><code>0xd3b6ba</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c24/0xaeb6e5_len.txt"><code>0xaeb6e5</code></a></td><td>(*o) CRC-24; CRC-24/6.1; FlexRay-24</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-24-flexray-a"><code>CRC-24/FLEXRAY-A</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-24-flexray-b"><code>CRC-24/FLEXRAY-B</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc24.html">24</a></td><td><code>0x800063</code></td><td><code>0xc60001</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c24/0xc00031_len.txt"><code>0xc00031</code></a></td><td>(*op) WCDMA-24</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-24-lte-b"><code>CRC-24/LTE-B</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-24-os-9"><code>CRC-24/OS-9</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc24.html">24</a></td><td><code>0x864cfb</code></td><td><code>0xdf3261</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c24/0xc3267d_len.txt"><code>0xc3267d</code></a></td><td>(*op) CRC-24-Radix-64</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-24-lte-a"><code>CRC-24/LTE-A</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-24-openpgp"><code>CRC-24/OPENPGP</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc30.html">30</a></td><td><code>0x2030b9c7</code></td><td><code>0x38e74301</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c30/0x30185ce3_len.txt"><code>0x30185ce3</code></a></td><td>(*op) CRC-30</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-30-cdma"><code>CRC-30/CDMA</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc31.html">31</a></td><td><code>0x04c11db7</code></td><td><code>0x76dc4190</code></td><td><code>0x42608edb</code></td><td>–</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-31-philips"><code>CRC-31/PHILIPS</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc32.html">32</a></td><td><code>0x000000af</code></td><td><code>0xf5000000</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c32/0x80000057_len.txt"><code>0x80000057</code></a></td><td>(*p) FP-32, CRC-32K/3</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-xfer"><code>CRC-32/XFER</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc32.html">32</a></td><td><code>0x04c11db7</code></td><td><code>0xedb88320</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c32/0x82608edb_len.txt"><code>0x82608edb</code></a></td><td>(*p) IEEE 802.3; CRC-32</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-bzip2"><code>CRC-32/BZIP2</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-cksum"><code>CRC-32/CKSUM</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-iso-hdlc"><code>CRC-32/ISO-HDLC</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-jamcrc"><code>CRC-32/JAMCRC</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-mpeg-2"><code>CRC-32/MPEG-2</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc32.html">32</a></td><td><code>0x1edc6f41</code></td><td><code>0x82f63b78</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c32/0x8f6e37a0_len.txt"><code>0x8f6e37a0</code></a></td><td>(*op) iSCSI; CRC-32C; CRC-32/4</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-iscsi"><code>CRC-32/ISCSI</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc32.html">32</a></td><td><code>0x741b8cd7</code></td><td><code>0xeb31d82e</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c32/0xba0dc66b_len.txt"><code>0xba0dc66b</code></a></td><td>(*o) CRC-32K/6.1</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-mef"><code>CRC-32/MEF</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc32.html">32</a></td><td><code>0x8001801b</code></td><td><code>0xd8018001</code></td><td><code>0xc000c00d</code></td><td>–</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-cd-rom-edc"><code>CRC-32/CD-ROM-EDC</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc32.html">32</a></td><td><code>0x814141ab</code></td><td><code>0xd5828281</code></td><td><a href="https://users.ece.cmu.edu/~koopman/crc/c32/0xc0a0a0d5_len.txt"><code>0xc0a0a0d5</code></a></td><td>(*op) CRC-32Q</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-aixm"><code>CRC-32/AIXM</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc32.html">32</a></td><td><code>0xf4acfb13</code></td><td><code>0xc8df352f</code></td><td>&lt; <a href="https://users.ece.cmu.edu/~koopman/crc/c32/0xfa567d89_len.txt"><code>0xfa567d89</code></a></td><td>(*o) CRC-32/6 corrected</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-autosar"><code>CRC-32/AUTOSAR</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc32.html">32</a></td><td><code>0xa833982b</code></td><td><code>0xd419cc15</code></td><td>= <a href="https://users.ece.cmu.edu/~koopman/crc/c32/0xd419cc15_len.txt"><code>0xd419cc15</code></a></td><td>CRC-32/5.1</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-32-base91-d"><code>CRC-32/BASE91-D</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc40.html">40</a></td><td><code>0x0004820009</code></td><td><code>0x9000412000</code></td><td><code>0x8002410004</code></td><td>–</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-40-gsm"><code>CRC-40/GSM</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc64.html">64</a></td><td><code>0x000000000000001b</code></td><td><code>0xd800000000000000</code></td><td><code>0x800000000000000d</code></td><td>(*p) FP-64, CRC-64-ISO</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-64-go-iso"><code>CRC-64/GO-ISO</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc64.html">64</a></td><td><code>0x259c84cba6426349</code></td><td><code>0x92c64265d32139a4</code></td><td>&lt; <code>0x92ce4265d32131a4</code></td><td>–</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-64-ms"><code>CRC-64/MS</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc64.html">64</a></td><td><code>0xad93d23594c935a9</code></td><td><code>0x95ac9329ac4bc9b5</code></td><td>&lt; <code>0xd6c9e91aca649ad4</code></td><td>(*p) Jones</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-64-redis"><code>CRC-64/REDIS</code></a></td></tr><tr><td><a href="https://users.ece.cmu.edu/~koopman/crc/crc64.html">64</a></td><td><code>0x42f0e1eba9ea3693</code></td><td><code>0xc96c5795d7870f42</code></td><td><code>0xa17870f5d4f51b49</code></td><td>(*o) CRC-64-ECMA</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-64-ecma-182"><code>CRC-64/ECMA-182</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-64-we"><code>CRC-64/WE</code></a>, <a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-64-xz"><code>CRC-64/XZ</code></a></td></tr><tr><td>82</td><td><code>0x0308c0111011401440411</code></td><td><code>0x220808a00a2022200c430</code></td><td><code>0x218460088808a00a20208</code></td><td>–</td><td><a href="https://reveng.sourceforge.io/crc-catalogue/all.htm#crc.cat.crc-82-darc"><code>CRC-82/DARC</code></a></td></tr></tbody></table>
