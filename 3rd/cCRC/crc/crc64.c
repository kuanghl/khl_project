...
uint64_t crc64_ecma( const unsigned char *input_str, size_t num_bytes ) {
...
uint64_t crc64_we( const unsigned char *input_str, size_t num_bytes ) {
...
uint64_t update_crc64( uint64_t crc, unsigned char c ) {
